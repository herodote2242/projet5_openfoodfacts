...
class DatabaseFeeder:
    ...
    def feed_products(self):
        ...
        for product in self.products:
            ...
            self.db.query("""INSERT INTO product (code, product_name, brand, url_link,
                ...
                :nutrition_grade_fr)
                ON DUPLICATE KEY UPDATE code = :code;""", code = int(product["code"]), product_name = product["product_name"], 
    ...
    def feed_product_category(self, product, category):
        ...
        self.db.query("""INSERT INTO product_category (product_code, category_id)
            VALUES (:code, (SELECT id FROM category WHERE name = :category));""",
